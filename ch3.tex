...
\begin{proof}
	...
	\end{align*}where in the last step we simply use the fact that, for instance, $u_1u_2w_1w_2=u_2u_1w_2w_1$, since the multiplication of real numbers is commutative, and so $2u_1u_2w_1w_2$ is just $u_1u_2w_1w_2+u_2u_1w_2w_1$.
	...
	}}^3(u_iw_j)^2\right)\\&=\abs{\gen{u,w}}^2+\norm{u\times w}^2.
