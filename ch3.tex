...
\begin{proof}
	...
	\[u-v'=(\mu_1p+\mu_2q)-\mu_1p=\mu_2q.\] Now, since $v\nparallel u$, this implies that $\mu_2$ cannot be zero. So we can write
	...
	\[v-u'=(\lambda_1p+\lambda_2q)-\lambda_2q=\lambda_1p.\]Once again, since $v$ and $u$ are non-null, we cannot have $\lambda_1$
\end{proof}
