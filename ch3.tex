...
\end{lemma}
\begin{proof}
	Let $f=f_A$, where $f_A$ is the linear function defined by $A$, as well as $v=f(e_1)$, $u=f(e_2)$ and $w=f(e_3)$. In this case, we have that $v=(a_{1,1},a_{2,1},a_{3,1})$, $u=(a_{1,2},a_{2,2},a_{3,2})$ and $w=(a_{1,3},a_{2,3},a_{3,3})$.
	...
	\begin{align*}
		...
		&=a_{1,1}(a_{2,2}a_{3,3}-a_{2,3}a_{3,2})-a_{2,1}(a_{1,2}a_{3,3}-a_{1,3}a_{3,2})+a_{3,1}(a_{1,2}a_{2,3}-a_{2,2}a_{1,3})\\
