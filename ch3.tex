...
\begin{df}
	Let $A\in M_{3\times 3}(\R)$ be a matrix. We define its \textbf{determinant} $\det A$ to be the real number $\det A$ given by
...
\begin{lemma}
	...
	\[\det A=a_{1,1}\det A'-a_{1,2}\det A''+a_{1,3}\det A'''\]where $A',A'',A'''\in M_{2\times 2}(\R)$ are the following matrices:
	\[A':=\begin{pmatrix}
