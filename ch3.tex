...
\begin{df}
	Let $v,u,w\in\R^3$ be three vectors. We say that they are \textbf{coplanar} if any one of them is in the plane through the origin containing the other two. In symbols: $v\in \R u+\R w$ or $u\in\R v+\R w$ or $w\in\R v+\R u$. We denote this by ${\stackrel{u}{_v\triangle_w}}$
\end{df}
