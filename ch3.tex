...
\begin{prop}
	Let $v,u\in \R^3$ be any two vectors. Then for any $w\in\R v$ we have that $\R v=\R w$ and for any $t\in \R v+\R u$ we have that $\R t+\R u=\R v+\R t=\R v+\R u$.
\end{prop}
\begin{proof}
	...
	\bigskip
	To prove the second statement, we proceed analogously: Take $t\in \R v+\R u$. This means that $t=\tau_1 v+\tau_2 u$ for some $\tau_1,\tau_2\in \R$.
	
	Given any $t'\in \R v+\R u$, once again we can write it as $t'=\tau'_1 v+\tau_2' u$, so
	\begin{align*}
		t'&=\tau'_1 v+\tau_2' u\\
		&=\tau'_1\frac{\tau_1}{\tau 1}v+\tau_2'\frac{\tau_2}{\tau_2}u\\
		&=\frac{\tau_1'}{\tau_1}\tau_1v+\frac{\tau'_2}{\tau_2}\tau_2u
	\end{align*}
\end{proof}