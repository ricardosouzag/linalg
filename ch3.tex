...
\begin{proof}
	...
	\begin{itemize}
		...
		Similarly, given any linear function $f:\R^3\to\R^3$, there are (once again not necessarily unique) real numbers $v'_1,v'_2,v'_3\in\R$ such that 
		\[f(v)=\sum_{i=1}^3v'_if(x_i).\]
		
		But since $f$ is linear, we can apply it 
	\end{itemize}
