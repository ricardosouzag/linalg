...
\begin{proof}
	...
	\end{align*}where in the last step we simply replaced, for instance, $2u_1u_2w_1w_2$ by $u_1u_2w_1w_2+u_2u_1w_2w_1$ since the multiplication of real numbers is commutative.
