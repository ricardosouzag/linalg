...
\end{proof}
\begin{cor}
	Let $X=\{x_1,x_2,\cdots x_n\}\subseteq\R^3$ be a finite set. Then $X$ is linearly dependent if, and only if, there's some $x\in X$ such that
	\[\R x\subseteq\bigcap_{x_i\in X\setminus \{x\}} \R x_i.\]
\end{cor}
\begin{proof}
	If there's some $x\in X$ such that
	\[\R x\subseteq\bigcap_{i=1}^n \R x_i,\]
\end{proof}