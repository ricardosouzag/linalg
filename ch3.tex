...
\begin{df}
	Let $f:\R^3\to\R^3$ be a linear function. We define the \textbf{determinant of $f$} to be the real number $\det f$ given by the signed volume of the cube with edges $f(e_1),f(e_2),f(e_3)$, where the sign is positive if $f:\{e_1,e_2,e_3\}\to\{f(e_1),f_(e_2),f(e_3)\}$ is a cycle, and negative otherwise.
\end{df}