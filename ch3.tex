...
\begin{prop}
	The additions defined above are associative, commutative, have identity and inverse elements, and the scalings defined above are associative, commutative, have identity and inverse elements, and are distributive over both scalar and matrix addition.
\end{prop}