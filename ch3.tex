...
\begin{proof}
	...
	\begin{itemize}
		...
		\bigskip
		Finally, let $f:\R^3\to\R^3$ be any linear function, and let $v=\sum_{i=1}^3v_ix_i$ as before (but now we know that the $v_i$s are uniquely determined).
		
		We can now write $f(v)$ as
