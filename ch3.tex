...
\begin{df}
	We define additions $$+:M_{3\times 1}(\R)\times M_{3\times 1}(\R)\to M_{3\times 1}(\R)$$ $$+:M_{1\times 3}(\R)\times M_{1\times 3}(\R)\to M_{1\times 3}(\R)$$ and scalar multiplications
	\[\cdot: \R\times M_{3\times 1}(\R)\to M_{3\times 1}(\R)\]
	\[\cdot: \R\times M_{1\times 3}(\R)\to M_{1\times 3}(\R)\]by putting
	\[A+B:=\begin{pmatrix}
...
\begin{prop}
	The additions defined above are associative, commutative, have identity and inverse elements, and the scalings defined above are associative, commutative and distributive over both scalar and matrix addition.
\end{prop}