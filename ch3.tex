...
\begin{proof}
	...
	\begin{itemize}
		...
		\[f(v)=\sum_{i=1}^3v_if(x_i),\]by simply applying $f$ on $v$ and using the fact that $f$ is linear. But we've just shown that there are unique real numbers $v'_1,v'_2,v_3'\in\R$ such that
		\[f(v)=\sum_{i=1}^3v'_ix_i.\]
	\end{itemize}
