...
\end{proof}
\begin{cor}
	Let $f:\R^3\to\R^3$ be a linear function, and let $g:\R^3\to \R^3$ be a linear function such that
	\[f(e_1)=g(e_1),\quad f(e_2)=g(e_3),\quad f(e_3)=g(e_2)\] in other words, the matrix of $g$ is just the matrix of $f$, but with the last two columns swapped.
	
	Then $\det g=-\det f$ as well as $\det A_g=-\det A_f$.
\end{cor}
\begin{proof}
