...
\begin{proof}
	...
	\begin{itemize}
		...
		That said, this is how this table should be filled-in: For instance, suppose we have $v(3)u$ and $u(2)w$. This means that ``$v_1=u_1$ and $v_2=u_2$, but $v_3<u_3$'' and ``$u_1=w_1$, but $u_2<w_2$''.
