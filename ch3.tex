...
\begin{proof}
	...
	\begin{itemize}
		...
		\[v=\left(\frac{u_3w_1-u_1w_3}{\lambda_1u_3},\frac{u_3w_2-u_2w_3}{\lambda_2u_3},0\right)\]which tells us that $v\in\R u+\R w$.
		
		This tells us that $v\parallel (w-u')$ if, and only if $\plane{v}{u}{w}$, but since we're assuming, by hypothesis, that $v,u,w$ are non-coplanar, we get that $v$ cannot be parallel to $w-u'$.
