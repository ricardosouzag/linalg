...
\begin{ex}
	...
	To see that, think of vectors as ``words'' in a dictionary. You start by comparing the first letter (in this case, the first entry): $w_1<v_1=u_1=z_1$, so we know $w$ comes before the others.
