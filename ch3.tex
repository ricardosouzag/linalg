...
\begin{proof}
	\begin{enumerate}[a)]
		...
		But then, this tells us that any three of $\{v,u,p,q\}$ are non-coplanar - and hence that the sum of the lines through them is $\R^3$ - so we already get that $X+Y=\R^3$.
