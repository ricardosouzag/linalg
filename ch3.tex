...
\begin{df}
	Let $\leq$ in $\R^3$ be a relation given by: $(v_1,v_2,v_3)\leq (u_1,u_2,u_3)$ if, and only if, any of the following hold:
	\begin{itemize}		
		\item $v_1\leq u_1$;
		\item $v_1=u_1$, but $v_2\leq u_2$;
		\item $v_1=u_1$ and $v_2=u_2$, but $v_3\leq u_3$;
		\item $v_i=u_i$ for all $1\leq i\leq 3$.
	\end{itemize}
...
\begin{proof}
	...
	\begin{itemize}
		...
		Let $v,u\in \R^3$ be such that $v\leq u$ and $u\leq v$. We need to show that this implies $v=u$.
	\end{itemize}
\end{proof}
