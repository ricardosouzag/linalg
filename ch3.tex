...
\begin{proof}
	...
	So there are real numbers $a_1,a_2,\cdots,a_{n-1},(-1)\in \R$ such that
	\[a_1x_1'+a_2x'_2+\cdots+a_{n-1}x'_{n-1}+(-1)x=0.\]
	...
	\[x_1=-a'_2x_2-a'_3x_3-\cdots-a'_nx_n.\]But this tells us that $x+1\in\spen X\setminus\{x_1\}$ - and so $X$ is linearly dependent.
