...
\begin{prop}
	Given any three vectors $v,u,w\in \R^3$, we have that $\R v+w$ is a line parallel to $\R v$ containing $w$, and $\R v+\R u+w$ is a plane parallel to $\R v+\R u$ containing $w$.
\end{prop}
