...
\begin{proof}
	...
	\bigskip
	By the same reasoning as above, we clearly have $\mb{XY+YZ+ZX}\subseteq \R^3$ simply because every element of $\mb{XY+YZ+ZX}$ is a vector in $\R^3$.
	
	Let us then prove that $\R^3\subseteq \mb{XY+YZ+ZX}$.
\end{proof}