...
\begin{proof}
	...
	\begin{itemize}
		...
		\begin{gather*}
			...
			w-\dfrac{w_3}{v_3}v=\lambda w-\lambda\dfrac{w_3}{u_3}u\\
			-\dfrac{w_3}{v_3}v=\lambda w-\lambda\dfrac{w_3}{u_3}u-w\\
			-\dfrac{w_3}{v_3}v=(\lambda-1) w-\lambda\dfrac{w_3}{u_3}u\\
			\dfrac{w_3}{v_3}v=\lambda\dfrac{w_3}{u_3}u-(\lambda-1) w
		\end{gather*}and since we're assuming that $w_3\neq 0$, we see that 
		\[v=\frac{v_3}{w_3}\left(\lambda\dfrac{w_3}{u_3}u-(\lambda-1) w\right)=\lambda\frac{v_3}{u_3}u-(\lambda-1)\frac{v_3}{w_3}w\]and so $v\in\R u+\R w$. But this contradicts our initial hypothesis that $v,u,w$ are non-coplanar.
		
		This shows that, indeed, $(w-v')\nparallel(w-u')$ and since they're both in $\mb{XY}$ and are non-parallel, we see, by the preceding lemma, that $\mb{XY}\subseteq\R(w-v')+\R(w-u')$.
...
This shows that $\mb{XY+YZ+ZX}\subseteq\R v+\R u+\R w$. But we've already proven that $\mb{XY+YZ+ZX}=\R^3$, so $\R^3\subseteq\R v+\R u+\R w\subseteq\R^3$ shows us that 
