...
\begin{proof}
	\begin{enumerate}[a)]
		...
		But then, this tells us that any three of $\{v,u,p,q\}$ are non-coplanar - and hence that the sum of the lines through them is $\R^3$. For instance, $v,u,p$ are non-coplanar, so $\R v+\R u+\R p=\R^3$. But this means that there exists some $q_1,q_2,q_3\in\R$ such that 
		\[q=q_1v+q_2u+q_3p.\]
	\end{enumerate}
\end{proof}
