...
\begin{proof}
	...
	\end{align*}and since $\left\{\left(-\frac{v_2}{v_1},1,0\right),\left(-\frac{v_3}{v_1},0,1\right)\right\}$ are linearly independent, this means that $v^\perp = \spen\left\{\left(-\frac{v_2}{v_1},1,0\right),\left(-\frac{v_3}{v_1},0,1\right)\right\}=\R\left(-\frac{v_2}{v_1},1,0\right)+\R\left(-\frac{v_3}{v_1},0,1\right)$.
\end{proof}