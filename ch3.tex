...
\[u^\perp=\{(x,y,z)\in \R^3\mid u_1x+u_2y+u_3z=0\}\]is a plane. Similarly, 
\[w^\perp=\{(x,y,z)\in \R^3\mid w_1x+w_2y+w_3z=0\}\]is also a plane. Therefore, $u^\perp\cap w^\perp$ is a line, given by
\[u^\perp\cap w^\perp=\{(x,y,z)\in\R^3\mid u_1x+u_2y+u_3z=0\mbox{ and }w_1x+w_2y+w_3z=0\}.\]
