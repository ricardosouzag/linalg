...
\begin{proof}
	...
	\begin{itemize}
		...
		\item But now we have $v_1=u_1$, $v_2=u_2$ and $v_3=u_3$ (otherwise we would have stopped at either the first, second or third steps) and this $v=u$.
	\end{itemize}

	No matter the case, then, we can always conclude either $v\leq u$ or $u\leq v$. This implies that $\leq$ is a total order and finishes the proof.
\end{proof}
