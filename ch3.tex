...
\begin{lemma}
	Let $X,Y\leq \R^3$ be any two subspaces, and take $v\in X\cap Y$. Then not only do we have $\R v\subseteq X\cap Y$, but also $X+\R v=X$ and $Y+\R v=Y$.
\end{lemma}
\begin{proof}
...
\end{proof}
\begin{cor}
	Let $X,Y,Z\leq \R^3$ be any three subspaces such that $Z\subseteq X$ or $Z\subseteq X$. Then $X+Y+Z=X+Y$.
\end{cor}
\begin{proof}
...
\begin{proof}
	...
	\begin{align*}
		...
		&=\frac{\tau_1'}{\tau_1}t-\frac{\tau_1'}{\tau_1}\tau_2u+\tau_2'u=\frac{\tau_1'}{\tau_1}t+\left(\tau_2'-\frac{\tau_1'}{\tau_1}\tau_2\right)
	...
	&=\left(\tau_1'-\frac{\tau_2'}{\tau_2}\tau_1\right)v+\frac{\tau_2'}{\tau_2}
	\end{align*}and we see that $t'\in \R v+\R t$.
	
	So clearly, $t'\in \R v+\R u$ implies $t'\in \R t+\R u$ or $t'\in \R v+\R t$ - in other words, $\R v+\R u\subseteq (\R t+\R u)+(\R v+\R t)$.
\end{proof}