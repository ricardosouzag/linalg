...
Finally, we're ready to prove one of the most beautiful theorems in all of mathematics: The First Isomorphism Theorem.

\begin{df}
	Let $f:\R^2\to\R^2$ be a linear function. We'll say that \textbf{$f$ is a linear isomorphism} (or just an isomorphism) if it is a set isomorphism (that is, a bijection).
\end{df}