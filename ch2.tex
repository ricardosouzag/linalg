...
\begin{ex}
	Consider the lines $\mb X$ (that is, $\R e_1$) and $\mb Y$ (that is, $\R e_2$). Then $X\cup Y$ is just the two axis together.
...
\begin{proof}
	...
	We'll show that $r+s$ contains both $e_1$ and $e_2$. This suffices, because we've already shown that $\R e_1+\R e_2=\R^2$.
