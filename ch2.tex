...
\begin{df}
	...
	\[XA:=\varphi^{-1}(\tau_A(\varphi_X)).\]
\end{df}

\begin{lemma}
	For any $A\in M_{2\times 2}(\R)$ and any $X\in M_{1\times 2}(\R)$ we have that \[XA=\begin{pmatrix}
	a_1x_1+a_3x_2&
	a_2x_1+a_4x_2
	\end{pmatrix}\]where $A=\begin{pmatrix}
	a_1&a_2\\
...
\begin{proof}
	...
	Therefore,
	\begin{align*}
	\tau_A(\varphi_X)&=\tau_A(x_1,x_2)\\
	&=\tau_A(x_1e_1+x_2e_2)\\
	&=x_1\tau_A(e_1)+x_2\tau_A(e_2)\\
	&=x_1(a_1,a_2)+x_2(a_3,a_4)\\
	&=(a_1x_1,a_2x_1)+(a_3x_2,a_4x_2)=(a_1x_1+a_3x_2,a_2x_1+a_4x_2)
	\end{align*}and we see that \[XA=\begin{pmatrix}
	a_1x_1+a_3x_2&
	a_2x_1+a_4x_2
	\end{pmatrix}\]which proves the result.
\end{proof}
...
\end{cor}
\begin{proof}
	This is trivial from the definition of the transpose map.
\end{proof}