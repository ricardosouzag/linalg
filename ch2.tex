...
\begin{proof}
	...
	\[\gen{v,u+w}=v_1(u_1+w_1)+v_2(u_2+w_2)=v_1u_1+v_1w_1+v_2u_2+v_2w_2=(v_1u_1+v_2u_2)+(v_1w_1+v_2w_2)=\gen{v,u}+\gen{v,w}\]
...
\begin{proof}
	...
	\[\norm{v-u}^2=\gen{v-u,v-u}\]and since we already know that the inner product
\end{proof}