...
\begin{proof}
	...
	This implies $\theta\in\{\frac{\pi}{2},\frac{3\pi}{2}\}$, but since we're only measuring internal angles, $0\leq \theta\leq\frac{\pi}{2}$. This implies that $\theta=\frac{\pi}{2}$ and so $v\perp u$.
