...
\begin{itemize}
	...
	\[x_i=\lambda_1x_1+\lambda_2x_2+\cdots+\lambda_ix_i+\cdots+\lambda_nx_n.\] But $\id_{\R^2}(x_i)=1\id_{\R^2}(x_1)$, and by definition of base, there's only one possible choice of $\lambda_j$'s. This shows that the only possible choice of $\lambda_i$ to make that true is taking $\lambda_i=1$ and every other $\lambda_j=0$ if $j\neq i$.
