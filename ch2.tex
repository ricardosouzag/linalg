...
\begin{proof}
	...
	\begin{itemize}
		...
		Take any $(v,u)\in V^2_A$. Then, there are uniquely determined $P,Q\in E_A$ such that $v=\overrightarrow{AP}$ and $u=\overrightarrow{AQ}$.
		...
		We claim that $f(\overrightarrow{AT})=(v,u)$.
	\end{itemize}
\end{proof}