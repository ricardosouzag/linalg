...
\begin{itemize}
	...
	Assume $X$ is a base for $\R^2$ and consider the canonical inclusion function $i:X\to \R^2$ given by $i(x):=x$ for all $x\in X$. Then, since $X$ is a base, it induces a unique linear transformation $i':\R^2\to\R^2$
\end{itemize}
\end{proof}