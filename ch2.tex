...
\end{proof}
\begin{cor}
	For any $n$-gon $v_1,v_2,\cdots,v_n$ its \underline{unsigned} area is just
...
\begin{ex}
	...
	\[\frac{\abs{2-3-6-1+1}}{2}=\frac{\abs{-7}}{2}=3.5\]which is precisely the same as we had gotten previously, but in the opposite direction.
\end{ex}