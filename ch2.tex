...
\begin{itemize}
	...
	\[v=\lambda_1x_1+\lambda_2x_2+\cdots+\lambda_n x_n\]which tells us that any $v\in \R^2$ is spanned by $X$ - in other words, $X$ spans $\R^2$. Therefore, since it is a spanning set and so $n\leq 2$.
