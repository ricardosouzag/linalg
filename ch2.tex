...
\begin{ex}
	...
	\[zz^{-1}=(x+iy)(\frac{x-iy}{x^2+y^2})=\frac{x^2+y^2}{x^2+y^2}=1\]so it is indeed an inverse for $z$.
\end{ex}
...
\begin{lemma}
	...
	\begin{enumerate}[(a)]
		...
		\item Let $1$ be a multiplicative identity of $k$. Then $-x=(-1)x$, where $-1$ is the additive inverse of $1$.
	\end{enumerate}
\end{lemma}
\begin{proof}
	\begin{enumerate}[(a)]
		...
		\[0x=(0+0)x=0x+0x\]since $k$ is a field and $0$ is the additive identity. Let 
	\end{enumerate}
\end{proof}