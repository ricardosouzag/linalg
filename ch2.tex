...
\begin{lemma}
	Any line $r\subseteq \R^2$ is of the following form:
	\[r=\{w\in \R^2\mid w=\lambda v+u, \lambda \in \R\}\]for some fixed $v,u\in \R^2$. 
	
	Equivalently, any line in $\R^2$ is just a a line through 0 added to another vector.
\end{lemma}
...
\begin{proof}
	...
	Let us make a new construction, on top of the previous one:
	\begin{enumerate}
		\item Take $t_u$ the line perpendicular to $u$ through the endpoint of $u$;
		\item Mark $P':=t_u\cap r_u$;
		\item Take $t_v$ the line parallel to $t_u$ through the origin;
		\item Mark $P'':=t_v\cap r_u$.
	\end{enumerate}
\[\definecolor{ududff}{rgb}{0.30196078431372547,0.30196078431372547,1.}
\definecolor{uuuuuu}{rgb}{0.26666666666666666,0.26666666666666666,0.26666666666666666}
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
...
x=1.0cm,y=1.0cm,
axis lines=middle,
xmin=-1.9999999999999996,
xmax=9.020000000000005,
ymin=-0.9400000000000015,
ymax=5.960000000000001,
xtick={-1.0,0.0,...,9.0},
ytick={-0.0,1.0,...,5.0},]
\clip(-2.,-0.94) rectangle (9.02,5.96);
\draw [->,line width=1.2pt] (0.,0.) -- (2.,4.);
\draw [->,line width=1.2pt] (0.,0.) -- (6.,1.);
\draw [line width=1.2pt,dotted,domain=-2.:9.02] plot(\x,{(-22.--4.*\x)/2.});
\draw [line width=1.2pt,dotted,domain=-2.:9.02] plot(\x,{(--22.--1.*\x)/6.});
\draw [->,line width=2.pt,dash pattern=on 3pt off 3pt] (0.,0.) -- (8.,5.);
\draw [line width=1.2pt,dotted,domain=-2.:9.02] plot(\x,{(-37.--6.*\x)/-1.});
\draw [line width=1.2pt,dotted,domain=-2.:9.02] plot(\x,{(-0.--6.*\x)/-1.});
\begin{scriptsize}
\draw [fill=uuuuuu] (0.,0.) circle (2.0pt);
\draw [fill=ududff] (2.,4.) circle (2.5pt);
\draw[color=black] (0.86,2.37) node {$v$};
\draw [fill=ududff] (6.,1.) circle (2.5pt);
\draw[color=black] (3.5,0.49) node {$u$};
\draw[color=black] (9.39,8.32) node {$r_v$};
\draw[color=black] (-3.51,2.98) node {$r_u$};
\draw [fill=uuuuuu] (8.,5.) circle (2.0pt);
\draw[color=uuuuuu] (8.36,5.33) node {$P$};
\draw[color=black] (3.86,2.81) node {$w$};
\draw [fill=uuuuuu] (-0.5945945945945946,3.5675675675675675) circle (2.0pt);
\draw[color=uuuuuu] (-0.88,3.89) node {$P''$};
\draw [fill=uuuuuu] (5.405405405405405,4.5675675675675675) circle (2.0pt);
\draw[color=uuuuuu] (5.6,4.89) node {$P'$};
\end{scriptsize}
\end{axis}
\end{tikzpicture}\]
\end{proof}