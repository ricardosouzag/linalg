...
\begin{proof}
	...
	\[\gen{v-u,v-u}=\gen{v,v}-\gen{u,v}-\gen{v,u}+\gen{u,u}\]which, since we already know the inner product is commutative, is simply
	\[\gen{v-u,v-u}=\gen{v,v}-2\gen{v,u}+\gen{u,u}\]
\end{proof}