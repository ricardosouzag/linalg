...
\begin{prop}
	Let $r,s\subseteq \R^2$ be two different lines through zero in $\R^2$. Then $r\cap s\iso 1$.
\end{prop}
\begin{proof}
...
\end{proof}
\begin{cor}
	Let $r,s\subseteq \R^2$ be two different lines in $\R^2$. Then $\#(r\cap s)\in\{0,1\}$.
\end{cor}
\begin{proof}
	Let $r=\R v_1+v_2$ and $s=\R u_1+u_2$ for some $v_1,v_2,u_1,u_2\in \R^2$.
	
	If $r\cap s=\varnothing$, there's nothing to do (since $\#r\cap s=0$ and we're done).
	
	Assume, then, that there are $x,y\in r\cap s$. We will show, then, that $x=y$.
	
	If that's the case, then there are real numbers $\lambda_1,\lambda_2,\mu_1,\mu_2\in\R$ such that
	...
	This shows that if we have two points in $r\cap s$, then they are in fact the same point. So $r\cap s$ has, at most, one point, which ends the proof.
\end{proof}