...
\begin{df}
	...
	\[\spen\{v\}:=\{u\in \R^2\mid \exists\lambda\in \R, u=\lambda v\}.\]
	...
	\[\spen\{v_1,v_2,\cdots,v_n\}:=\{u\in \R^2\mid \exists\{\lambda_1,\lambda_2,\cdots,\lambda_n\}\subseteq\R,u=\lambda_1v_1+\lambda_2v_2+\cdots+\lambda_nv_n\}.\]
\end{df}