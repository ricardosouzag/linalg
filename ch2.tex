...
\draw [line width=0.4pt,dotted,domain=-0.94:9.02] plot(\x,{(-22.--4.*\x)/2.});
\draw [line width=0.4pt,dotted,domain=-0.94:9.02] plot(\x,{(--22.--1.*\x)/6.});
\draw [->,dash pattern=on 3pt off 3pt] (0.,0.) -- (8.,5.);
\draw  (6.,-0.94) -- (6.,5.98);
\draw  (8.,-0.94) -- (8.,5.98);
\draw  (2.,-0.94) -- (2.,5.98);
...
\draw [line width=0.4pt,domain=-0.94:9.02] plot(\x,{(-1.-0.*\x)/-1.});
