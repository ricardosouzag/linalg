...
\begin{df}
	A set $\{x_1,x_2\}\subseteq \R^2$ is called a \textbf{base of $\R^2$} or a \textbf{basic set} if $$\hom(\{x_1,x_2\},\R^2)\iso\hom_\R(\R^2,\R^2)$$ that is, every linear function $f:\R^2\to\R^2$ is of the form $f(a,b)=a'f(x_1)+b'f(x_2)$ for some $a',b'\in R$.
\end{df}
