...
\begin{ex}
	...
	\draw [->,line width=2.pt] (0.94,0.96) -- (2.2,3.56);
	\draw [->,line width=2.pt] (0.94,0.96) -- (-2.32,1.66);
	\draw [->,line width=2.pt] (0.94,0.96) -- (-0.06,-1.7);
	\draw [->,line width=2.pt] (0.94,0.96) -- (5.5,0.1);
	\draw [->,line width=2.pt] (0.94,0.96) -- (4.34,2.82);
	\begin{scriptsize}
	\draw [fill=ududff] (0.94,0.96) circle (2.5pt);
