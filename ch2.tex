...
\begin{proof}
	...
	\[\frac{\det(v_1,v_{i-1})+\det(v_{i-1},v_i)+\det(v_i,v_1)}{2}+\frac{\det(v_1,v_i)+\det(v_i,v_{i+1})+\det(v_{i+1},v_1)}{2}\]and since $\det(v,u)=-\det(u,v)$ the terms in the middle cancel out, so this whole sum becomes just
