...
\begin{ex}
	...
	\draw [->] (0.,0.) -- (4.,1.) node[below,midway] {$v$};
	\draw [->] (0.,0.) -- (2.,3.) node[above,midway] {$u$};
	\draw [dash pattern=on 2pt off 2pt] (2.,3.)-- (2.588235294117647,0.6470588235294117) node[anchor=southwest,midway,above] {$\norm{u}\sin\theta'$};
