...
Finally, we're not gonna do the computations, but this allows us to compute the are of \textbf{any} polygon in the plane.
...
x=1.0cm,y=1.0cm,
axis lines=middle,
xmin=-1.058242252186567,
xmax=4.001207714452287,
ymin=-1.0020029167002655,
ymax=4.014661003709084,
xtick={-1.0,0.0,...,4.0},
ytick={-1.0,0.0,...,4.0},]
\clip(-1.058242252186567,-1.0020029167002655) rectangle (4.001207714452287,4.014661003709084);
\fill[line width=2.pt,color=zzttqq,fill=zzttqq,fill opacity=0.30000001192092896] (1.,1.) -- (0.,2.) -- (1.5,3.) -- cycle;
\fill[line width=2.pt,color=qqqqff,fill=qqqqff,fill opacity=0.30000001192092896] (1.,1.) -- (1.5,3.) -- (3.,2.) -- cycle;
\fill[line width=2.pt,color=yqqqyq,fill=yqqqyq,fill opacity=0.30000001192092896] (1.,1.) -- (3.,2.) -- (2.,1.) -- cycle;
\draw [line width=2.pt,color=zzttqq] (1.,1.)-- (0.,2.);
\draw [line width=2.pt,color=zzttqq] (0.,2.)-- (1.5,3.);
\draw [line width=2.pt,color=zzttqq] (1.5,3.)-- (1.,1.);
\draw [line width=2.pt,color=qqqqff] (1.,1.)-- (1.5,3.);
\draw [line width=2.pt,color=qqqqff] (1.5,3.)-- (3.,2.);
\draw [line width=2.pt,color=qqqqff] (3.,2.)-- (1.,1.);
\draw [line width=2.pt,color=yqqqyq] (1.,1.)-- (3.,2.);
\draw [line width=2.pt,color=yqqqyq] (3.,2.)-- (2.,1.);
\draw [line width=2.pt,color=yqqqyq] (2.,1.)-- (1.,1.);
\begin{scriptsize}
\draw [fill=uququq] (0.,2.) circle (2.0pt) node[above] {$v_2$};
\draw [fill=uququq] (1.5,3.) circle (2.0pt) node[above] {$v_3$};
\draw [fill=uququq] (1.,1.) circle (2.0pt) node[above] {$v_1$};
\draw [fill=uququq] (3.,2.) circle (2.0pt) node[above] {$v_4$};
\draw [fill=uququq] (2.,1.) circle (2.0pt) node[above] {$v_5$};
\end{scriptsize}
\end{axis}
\end{tikzpicture}\]		
\end{ex}