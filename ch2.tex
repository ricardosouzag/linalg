...
\begin{proof}
	...
	Let us call $d_1=d(v,u)$, $d_2=d(v,w)$ and $d_3=d(u,w)$. Then if either of these is zero, the result follows. For instance, $d_2=0$ implies $v=w$ (so they lie in the same line), and since between any two points there's always a line, this implies that $u$ is also in a line with $v$ and $w$.
