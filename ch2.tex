...
\begin{proof}
	...
	\begin{align*}
		d\left(\frac{1}{2}(v+u),v\right)&=\norm{\left(\frac{1}{2}(v+u)\right)-v}
	\end{align*}but since we know that $\frac{1}{2}(v+u)=-\frac{1}{2}(v-u)+v$ this becomes
	\begin{align*}
		d\left(\frac{1}{2}(v+u),v\right)&=\norm{\left(\frac{1}{2}(v+u)\right)-v}\\
		&=\norm{\frac{1}{2}v+\frac{1}{2}u-v}\\
		&=\norm{-\frac{1}{2}v+\frac{1}{2}u}\\
		&=\norm{-\frac{1}{2}(v-u)}\\
		&=\abs{-\frac{1}{2}}\norm{v-u}\\
...
\begin{df}
	Given $x\in \R^2$ and $r\in \R$, a \textbf{circle of radius $r$ and center $x$} is the set $\mc C(x,r)$ given by
