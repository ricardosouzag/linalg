...
\begin{proof}
	...
	\begin{itemize}
		...
		Now we can apply $f$ to see that $f(z)=\mu_1f(v')+\mu_2f(u')$. But $f(z)=0$, $f(v')=v$ and $f(u')=u$, which tells us that $0=\mu_1v+\mu_2u$ is another way to write $0$. But $\{v,u\}$ form a base, so there's a unique way - which, as we've seen above, is $0=0v+0u$.
