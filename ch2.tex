...
\begin{proof}
	...
	\[\cos\theta=\frac{\gen{v,u}}{\norm{v}\norm{u}}=\frac{0}{\norm{v}\norm{u}}=0\]so $cos\theta=0$. But this implies $\theta\in\{\frac{\pi}{2},\frac{3\pi}{2}\}$, but since we're only measuring internal angles, $\theta\leq\frac{\pi}{2}$. This implies that $\theta=\frac{\pi}{2}$ and so $v\perp u$.
