...
\begin{ex}
	Consider the vectors $v=(2,1)$, $u=(1,1)$.  Now, we can construct various lines: $\R v$, $\R u$, $v+\R u$, $u+\R v$ and $\R(v+u)$, for instance.
	...
	\draw[color=black] (1.351820037000329,2.1811038806620817) node {$w$};
	\end{scriptsize}
	\end{axis}
	\end{tikzpicture}\]
\end{ex}