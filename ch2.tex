...
Finally, to end this section, let us give some examples of fields that aren't $\Q$, $\R$ or $\C$.
...
\begin{ex}
	...
	In this case, $p={0,1,2}$, and so we have the following table of operations:
