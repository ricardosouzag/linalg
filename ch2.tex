...
\draw [->] (0.,0.) -- (2.,4.);
\draw [->] (0.,0.) -- (6.,1.);
\draw [dotted,domain=-2.:9.02] plot(\x,{(-22.--4.*\x)/2.});
\draw [dotted,domain=-2.:9.02] plot(\x,{(--22.--1.*\x)/6.});
\draw [->,dash pattern=on 3pt off 3pt] (0.,0.) -- (8.,5.);
\draw [dotted,domain=-2.:9.02] plot(\x,{(-37.--6.*\x)/-1.});
\draw [dotted,domain=-2.:9.02] plot(\x,{(-0.--6.*\x)/-1.});
\begin{scriptsize}
...
By construction, then, we see that the triangles $0P''v$ and $uP'P$ are similar.
\end{proof}