...
\begin{proof}
	...
	\begin{itemize}
		...
		Let $f:\R^2\to \R^2$ be a linear surjection and choose $v\in \Ker f$.
		
		If $v\neq 0$, then $\R v\subseteq \Ker f$, since $\Ker f$ is a subspace. 
		
		Choose now a base $X=\{x_1,x_2\}\subseteq \R^2$. By definition of base, we know that for any $u\in \R^2$ there exists some uniquely determined $\lambda_1,\lambda_2$ such that $f(u)=\lambda_1 f(x_1)+\lambda_2f(x_2)$.
	\end{itemize}
\end{proof}