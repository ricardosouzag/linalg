...
\end{lemma}
\begin{proof}
	First, notice that any rhombus can be considered as having vertices $0v(v+u)u$ where $\norm v=\norm u$.
	...
	Finally, notice that showing $\R(v+u)\perp\R(v-u)$ is the same as showing that $(v+u)\perp (v-u)$.
