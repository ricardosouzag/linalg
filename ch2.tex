...
\begin{proof}	
	...
	\draw [domain=-0.2:9.] plot(\x,{(--28.1568-2.08*\x)/8.92});
	\draw [domain=-0.2:9.] plot(\x,{(--1.8632--8.92*\x)/2.08});
	\draw [dotted,domain=-0.2:9.] plot(\x,{(-58.4136--8.92*\x)/2.08});
	\draw [dotted,domain=-0.2:9.] plot(\x,{(-51.9936--2.08*\x)/-8.92});
	\begin{scriptsize}
	\draw [fill=ududff] (0.5,3.04) circle (2.5pt);
	\draw[color=ududff] (0.76,2.71) node {$*$};
