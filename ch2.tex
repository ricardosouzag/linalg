...
\begin{lemma}
	The set $M_{2\times 1}(\R)$ of all $2\times 1$ has an addition $A:M_{2\times 1}(\R)\times M_{2\times 1}(\R)\to M_{2\times 1}$ and a scalar multiplication $M:\R\times M_{2\times 1}(\R)$ satisfying:
	\begin{multicols}{2}
		\begin{itemize}
			\item $A$ is associative;
			\item $A$ is commutative;
