...
\begin{proof}
	...
	Since this holds true for any $T\in t$, we have that $f(t)\subseteq \{(x,y)\in\R^2\mid x=\lambda x_t \mbox{ and }y=\lambda y_t,\mbox{ for some }\lambda\in\R\}$.
	
	\bigskip
	Conversely, take any $(x,y)\in \{(x,y)\in\R^2\mid x=\lambda x_t \mbox{ and }y=\lambda y_t,\mbox{ for some }\lambda\in\R\}$.
\end{proof}