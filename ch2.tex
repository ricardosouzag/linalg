...
\begin{ex}
	...
	\draw [shift={(0.,0.)},color=qqwuqq,fill=qqwuqq,fill opacity=0.10000000149011612] (0,0) -- (14.036243467926477:0.6) arc (14.036243467926477:56.309932474020215:0.6) -- cycle;
	\draw [->] (0.,0.) -- (4.,1.);
	\draw [->] (0.,0.) -- (2.,3.);
	\draw [dash pattern=on 1pt off 1pt] (2.,3.)-- (2.588235294117647,0.6470588235294117);
