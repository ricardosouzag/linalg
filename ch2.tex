...
\begin{theorem}
	Let $f:\R^2\to\R^2$ be a linear function. Then $f$ is a linear isomorphism if, and only if, for every base $\mc B\subseteq \R^2$, $\det A_f^{\mc B}=0$, where $A_f^{\mc B}$ is the matrix of $f$ in the base $\mc B$.
\end{theorem}