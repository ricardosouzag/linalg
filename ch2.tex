...
But we've already proven that if we take any two non-parallel vectors then they span the whole $\R^2$. That means that if we take any three non-parallel vectors, then any one of them is already spanned by the other two.
