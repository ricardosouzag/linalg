...
\end{df}
\begin{prop}
	The transpose map is a bijection.
\end{prop}
\begin{proof}
...
\end{proof}
\begin{df}
	By an abuse of notation, we'll denote $((-)^t)^{-1}=(-)^t$. That is, the symbol $(-)^t$ means both the process of turning a $2\times 1$ matrix into a $1\times 2$ matrix and its inverse process of turning a $1\times 2$ matrix into a $2\times 1$ matrix.
\end{df}

\begin{df}
	We define the \textbf{transpose map} (once again, by abuse of notation) $(-)^t:M_{2\times 2}(\R)\to M_{2\times 2}$ to be the map given by $A^t=\tau(\phi_A)$.
\end{df}