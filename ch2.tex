...
\begin{prop}
	Let $f,g:\R^2\to\R^2$ be two linear functions and $\lambda\in \R$  be any scalar. Then the functions $f+g,f\circ g,\lambda f:\R^2\to\R^2$ defined, respectively, as $(f+g)(v):=f(v)+g(v)$, $(f\circ g)(v):=f(g(v))$ and $(\lambda f)(v):=f(\lambda v)$ are linear functions.
\end{prop}
\begin{proof}
