...
\begin{proof}
	...
	\begin{itemize}
		...
		Let $P\in E_A$ be a point. Consider the directer segment $\overleftarrow{AP}$. It is, by definition, a vector in $V_A$ whose endpoint is $P$, and, hence, $t(\overleftarrow{AP})=P$, and so $t$ is surjective.
	\end{itemize}
