...
\begin{lemma}
	...
	\[\frac{\det(v_1,v_2)+\det(v_2,v_3)+\cdots+\det(v_{n-1},v_n)}{2}.\]
\end{lemma}
\begin{proof}
	...
	\begin{itemize}
		...
		\[A(v_1,v_2,\cdots,v_n,v_{n+1})=A(v_1,v_2,v_3)+A(v_1,v_3,v_4)+\cdots+A(v_1,v_{n-1},v_n)+A(v_1,v_n,v_{n+1})\]but $A(v_1,v_2,v_3)+A(v_1,v_3,v_4)+\cdots+A(v_1,v_{n-1},v_n)$ is just $A(v_1,v_2,\cdots,v_n)$.
	\end{itemize}
\end{proof}