...
\end{lemma}
\begin{proof}
	Assume $(v+u)\parallel(v-u)$. Since they are lines through zero, this means they are equal, $\R(v+u)=\R(v-u)$. Let's call $r=\R (v+u)=\R(v-u)$.
...
\begin{proof}
	...
	Then, the midpoint of the diagonal $0(v+u)$ is just $\frac{1}{2}(v+u)$.
\end{proof}