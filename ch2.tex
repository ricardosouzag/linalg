...
\begin{proof}
	...
	Now take any point $T\in t$, and look at the vectors $\overrightarrow{AT_r}$ and $\overrightarrow{AT_s}$. We can then call $\lambda_T:=\dfrac{\mathrm{sgn}(\overrightarrow{AT_r})\norm{AT_r}}{x_t}$.
\end{proof}