...
\draw [->] (0.,0.) -- (2.,4.);
\draw [->] (0.,0.) -- (6.,1.);
\draw [line width=1.2pt,dotted,domain=-0.92:9.04] plot(\x,{(-22.--4.*\x)/2.});
\draw [line width=1.2pt,dotted,domain=-0.92:9.04] plot(\x,{(--22.--1.*\x)/6.});
...
\draw[color=black] (3.86,5) node {$v+u$};

\draw[color=black] (3.86,2.81) node {$r_u$};

\draw[color=black] (6.86,2.81) node {$r_v$};
\end{scriptsize}
\end{axis}
\end{tikzpicture}\]