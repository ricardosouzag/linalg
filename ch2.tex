...
\begin{df}
	Let $Y\in M_{1\times 2}(\R)$ and $X\in M_{2\times 1}(\R)$. Inspired by the evaluation maps, we define the \textbf{multiplication of $Y$ and $X$} to be the real number $YX$ given by \[\begin{pmatrix}
	y_1&y_2
	\end{pmatrix}\begin{pmatrix}
	x_1\\x_2
...
\begin{proof}
	...
	We'll only show (a), (b), (d), (f), (h) and (i), as the others are similar.
	...
	\begin{enumerate}[a)]
		\item \begin{align*}
			...
			y_1&y_2
			\end{pmatrix}\begin{pmatrix}
			a_1x_1+a_2x_2\\a_3x_1+a_4x_2
			\end{pmatrix}\\
			&=\begin{pmatrix}
			a_1x_1y_1+a_2x_2y_1+a_3x_1y_2+a_4x_2y_2
			\end{pmatrix}\\
			&=\begin{pmatrix}
			a_1y_1+a_3y_2&a_2y_1+a_4y_2
			\end{pmatrix}\begin{pmatrix}
			x_1\\x_2
			\end{pmatrix}\\
			&=\left(\begin{pmatrix}
		...
		\item[b)] \begin{align*}
			...
			x_1\\x_2
			\end{pmatrix}\\
			&=(y_1+y_1')x_1+(y_2+y_2')x_2\\
			&=x_1y_1+x_1y'_1+x_2y_2+x_2y_2'\\
			...
			\end{pmatrix}\begin{pmatrix}
			x_1\\x_2
			\end{pmatrix}\right)=YX+Y'X
			\end{align*}
			
			\item[d)] \begin{align*}
			(Y+Y')A&=\left(\begin{pmatrix}
			y_1&y_2
			\end{pmatrix}+\begin{pmatrix}
			y_1'&y_2'
			\end{pmatrix}\right)\begin{pmatrix}
			...
			\end{pmatrix}\\
			&=\begin{pmatrix}
			a_1(y_1+y_1')+a_3(y_2+y_2')&a_2(y_1+y_1')+a_4(y_2+y_2')
			\end{pmatrix}\\
			&=\begin{pmatrix}
			a_1y_1+a_1y_1'+a_3y_2a_3+y_2'&a_2y_1+a_2y_1'+a_4y_2+a_4y_2'
			\end{pmatrix}\\
			&=\begin{pmatrix}
			(a_1y_1+a_3y_2)+(a_1y_1'+a_3y_2')&(a_2y_1+a_4y_2)+(a_2y_1'+a_4y_2')
			\end{pmatrix}\\
			&=\begin{pmatrix}
			a_1y_1+a_3y_2&a_2y_1+a_4y_2
			\end{pmatrix}+\begin{pmatrix}
			...
			\item[f)]\begin{align*}
				...
				y_1&y_2
				\end{pmatrix}\begin{pmatrix}
				a_1a_1'+a_2a_3'&a_1a_2'+a_2a_4'\\a_3a_1'+a_4a_2'&a_3a_2'+a_4a_4'
				\end{pmatrix}
			\end{align*}
	\end{enumerate}
\end{proof}