...
\begin{proof}
	...
	Take then $v=(v_1,v_2)\in \mc C$, so $v_1^2+v_2^2=r^2$, that is, $\norm v=r$. Therefore, $v+c=(v_1+c_1,v_2+c_2)$. Then:
...
\begin{proof}
	...
	By the preceding proposition, we know that $\mc C'=\{(x,y)\in\R^2\mid x^2+y^2=r^2\}$.
\end{proof}