...
\begin{ex}
	...
	If, however, you'd like to learn more about partial operations, you should click \href{https://lmgtfy.com/?q=groupoid}{here} to Google for ``groupoid'' - which is precisely the mathematical notion of a set with an associative partial operation.
\end{ex}