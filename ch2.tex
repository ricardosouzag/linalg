...
\begin{df}
	The bijection $\phi:\hom_\R(\R^2,\R^2)\to M_{2\times 2}(\R)$ induces, for all $X,Y\in M_{2\times 2}(\R)$ and $\lambda\in \R$, $X+Y$, $XY$ and $\lambda X$ by putting $$X+Y:=\phi(\phi_X+\phi_Y)$$ $$XY:=\phi(\phi_X\circ \phi_Y)$$ $$\lambda X:=\phi(\lambda \phi_X),$$ where $\phi_X=\phi^{-1}(X)$ and $\phi_Y=\phi^{-1}(Y)$.
\end{df}
...
\begin{df}
	We define the \textbf{transpose map} (once again, by abuse of notation) $(-)^t:M_{2\times 2}(\R)\to M_{2\times 2}(\R)$ to be the map given by $A^t=\tau(\phi_A)$.
...
\end{prop}
\begin{proof}
	This is immediate from the definition of the transpose map: Since $(-)^t=\tau\circ \phi^{-1}$ and both $\tau$ and $\phi^{-1}$ are bijections, the result follows.
\end{proof}
\begin{df}
	By an abuse of notation, we'll once more denote $((-)^t)^{-1}=(-)^t$. That is, the symbol $(-)^t$ means both the process of turning the rows of a $2\times 2$ into the columns of a $2\times 2$ matrix as well as its inverse process of turning the columns of a $2\times 2$ matrix into the rows of a $2\times 2$ matrix.
\end{df}