...
\end{cor}
\begin{proof}
	Let $\mc C(x,r)$ be a circle of center $x$ and radius $r$, $s=\R v+u$ be a line and $y\in\R^2$ be a point such that $d(x,y)<r$ (this is what it means to say that $y$ is in the inside of a circle).
