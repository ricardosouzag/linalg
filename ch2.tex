...
\begin{lemma}
	...
	\[\mc D(R,r):=\{w\in \R^2\mid d(w,r)=R\}\]is just the set $s\cup t$ where $s=\R v+\overrightarrow{R}$ and $t=\R v-\overrightarrow{R}$, and $\overrightarrow{R}\in \R^2$ is any vector such that $\overrightarrow{R}\perp r$ and $\norm{\overrightarrow{R}}=R$.
\end{lemma}
\begin{proof}
