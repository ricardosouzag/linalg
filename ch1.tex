...
But $B'=\N\setminus B$. So $B=\N\setminus B'=\N\setminus\N=\varnothing$ and, therefore, the only subset of $\N$ which doesn't have a minimum is $\varnothing$ - this proves that $\N$ is well-ordered, as we wished to prove.
\end{proof}