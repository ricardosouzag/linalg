...
\begin{proof}
	\begin{itemize}
		...
		Assume that $\hom(f,Y)\circ\phi=\phi_B\circ\hom(f,X)$ holds for any choice of $A$, $B$ and $f$. So if we take $f:Y\to X$ any function, by applying the equality above to $\id_X$ we see that
