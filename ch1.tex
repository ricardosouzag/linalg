...
\begin{cor}
	Let $f:n\to m$ be an injection that is not a surjection. Then $n\in m$.
	
	Analogously, if $f$ is a surjection that is not an injection, then $m\in n$.
\end{cor}
\begin{proof}
	If $f:n\to m$ is injective, then $\im(f)\iso n$.
\end{proof}
