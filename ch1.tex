...
\begin{df}
	...
	\begin{enumerate}[i.]
		...
		\item If $Z$ is a set with a function $p_n:Z\to A_n$ from $Z$ to $A_n$, for each $n\in I$, then there's a unique function $p:Z\to\prod_{i\in I}A_i$ such that we have an equation $p_n=\pi_n\circ p$ for all $n\in I$.
	\end{enumerate}
\end{df}
