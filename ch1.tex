...
\end{theorem}
\begin{proof}
	To prove that they are different, we'd need to show that there's either some element of $\varnothing_A$ which is not in $\varnothing_B$, or some element of $\varnothing_B$ which is not in $\varnothing_A$. But both of these are impossible, since both sets are empty.
