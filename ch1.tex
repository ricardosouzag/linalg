...
Well, I don't know. But if it wasn't, then, by definition, all elements of $N$ are non-weird sets, so $N$, being an element of $N$, would have to be a non-weird set - that is, $N\in N$. So... If we assume that $N\notin N$ we can logically infer that $N\in N$...
