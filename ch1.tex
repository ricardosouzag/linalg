...
\begin{proof}
	\begin{enumerate}[(a)]
		...
		& A\times B \arrow[ld, "\pi'_A"'] \arrow[rd, "\pi'_B"]                                                                                   &   \\
		A &                                                                                                                                        & B
		\end{tikzcd}\](that is, $\pi_A=\phi_{A\times B}\circ\pi'_A$ and $\pi_B\circ\pi_{B\times C}=\phi_{A\times B}\circ\pi'_B$).
		...
		A\times B &                                                                                                                                                             & C
		\end{tikzcd}\](that is, $\phi_{A\times B}=\pi_{A\times B}\circ\phi_{(A\times B)\times C}$ and $\pi_C\circ\pi_{B\times C}=\phi_{(A\times B)\times C}\circ\pi'_C$).
	\end{enumerate}
\end{proof}
