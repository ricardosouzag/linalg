...
This function is clearly injective by definition (since, for each $n\in \N$, $f(n)$ is chosen from a set that doesn't contain any of $f(0)$ up to $f(n-1)$). Therefore, it has a left-inverse $g:X\to\N$ such that $\id_{\N}=g\circ f$.
