...
\begin{df}
	Let $A,B$ be sets and $\phi$ be a function from $A$ to $B$. We will call $A$ the \textbf{domain} of the function and $B$ its \textbf{codomain}, somtimes written as $\mathrm{Dom}(\phi)$ and $\mathrm{Cod}(\phi)$.
\end{df}
