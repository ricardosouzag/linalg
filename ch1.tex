...
\begin{lemma}
	Let $(A,\leq)$ be a poset. If $X\subseteq A$ is totally ordered, then the concepts of maximum and maximal coincide in $X$, as do the concepts of minimum and minimal.
\end{lemma}