...
\begin{lemma}
	...
	\begin{enumerate}[(a)]
		\item $A\times B$ is isomorphic to $B\times A$ (but not equal);
		\item $A\times(B\times C)$ is isomorphic to $(A\times B)\times C$ (but not equal);
		\item $A\times 0=0$;
		\item $A\times 1$ is isomorphic to $A$ (but not equal).
	\end{enumerate}
\end{lemma}
