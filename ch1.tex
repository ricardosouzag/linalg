...
\begin{ex}
	...
	\begin{itemize}
		...
		\item (Anti-symmetry) If both of $n\leq m$ and $m\leq n$ hold, for some $n,m\in \N$, then $n=m$;
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		Hence, we'd get that both $g$ and $f$ are also bijective, which is absurd, because we'd be able to show that $n=m$ while $n\in m$, and we know this cannot be true;
	...
	Since the only case that doesn't let to a contradiction is (4), we have that the only possible way that we can have both of $n\leq m$ and $m\leq n$ at once is if $n=m$. This shows that $\leq$ is anti-symmetric.
