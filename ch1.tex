...
\begin{df}
	Let $A$ be a set with a partial order $\leq$. We call the ordered pair $(A,\leq)$ a \textbf{poset} (\textbf{p}artiially-\textbf{o}rdered \textbf{set}).
