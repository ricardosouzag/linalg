...
\begin{proof}
	...
	Take then any set $A$ and look at $f\in\hom(X,A)$ and $g\in\hom(Y,A)$, and consider the maps $\phi:\hom(X,X)\to\hom(X,A)$ and $\varphi:\hom(X,Y)\to\hom(Y,A)$ given, respectively, by $\phi(f'):=f\circ f'$ and $\varphi(g'):=g\circ g'$.
\end{proof}