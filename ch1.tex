...
\begin{proof}
	\begin{enumerate}[(a)]
		...
		\[f^{-1}=((g\circ f)^{-1}\circ(g\circ f))\circ f^{-1}=(g\circ f)^{-1}\circ((g\circ f)\circ f^{-1})=(g\circ f)^{-1}\circ(g\circ (f\circ f^{-1})).\] Finally, by composing $f$ on the left on both sides of the equation we get $\id_B=(f\circ (g\circ f)^{-1})\circ g$, and so $f\circ(g\circ f)^{-1}$ is a left-inverse for $g$.
