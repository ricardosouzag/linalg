...
\begin{ex}
	...
	\bigskip
	Imagine that $C$ was a large blue paint can, and $D$ was a giant red paint can. Now, putting the elements from $C$ and $D$ together, we can see that the $a$ and the $e$ that came from $C$ are blue, whereas the corresponding elements from $D$ re red.
