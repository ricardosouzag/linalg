...
\begin{df}
	...
	In symbols, we write that as $aRb$.
\end{df}

\begin{ex}
	Still on that example, take for instance $R_1$. Then we have $1R_12$ (this means ``2 is the double of 1'', or ``1 is related to 2 via $R_1$'') and $2R_14$.
	
	Similarly, we have $1R_52$ (this means ``5 is greater than 1'', or ``1 is related to 5 via $R_5$''), $1\rel{R_5}4$ and $2R_54$ on $R_5$.
\end{ex}
...
\end{prop}
\begin{prop}
	A relation $R\subseteq A\times B$ is a function if, and only if, for each $a\in A$ there's a unique $b\in B$ such that $aRb$.
\end{prop}
