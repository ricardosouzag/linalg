...
\begin{proof}
	\begin{itemize}
		...
		Let $Y\leq Z$ and $Z\leq Y$, for some $Y,Z\in\mc P(X)$. Then, by definition of $\leq$, there are injections $f:Y\to Z$ and $g:Z\to Y$. Now, since composition of injections is, again, an injection, we see that $f\circ g:Z\to Z$ and $g\circ f:Y\to Y$ are injections.
	\end{itemize}
\end{proof}