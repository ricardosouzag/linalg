...
\begin{lemma}\label{thm:iso is mono}
...
\begin{lemma}\label{thm: iso is epi}
...
\end{theorem}
\begin{proof}
	In light of the \Cref{thm: iso is epi,thm:iso is mono}, we see that every isomorphism is monic and epic and, therefore, a bimorphism.
