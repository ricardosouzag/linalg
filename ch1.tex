...
\end{proof}
\begin{cor}
	Let $X$ be a set. Then $Y\leq Z$ in $\mc P(X)$ if, and only if, there is a surjection $g:Z\to Y$.
\end{cor}
\begin{proof}
	Follows trivially from the fact that every injection has a left-inverse which is surjective.
\end{proof}