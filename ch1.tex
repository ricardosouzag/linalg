...
\begin{ex}
	Let $\N$ be the set of natural numbers. Remember that this set has a natural order $\leq$ given by
	\[n\leq m\iff n\in m \mbox{ or }n=m\]which is just the usual order we're used to: $0\leq 1\leq 2\leq 3\leq 4\leq\cdots$.
\end{ex}