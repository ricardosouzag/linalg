...
\begin{df}
	Given a set $A$, an order $\leq $ in $A$ is said to be a \textbf{well-order} (I hate this term, so I usually call it a good-order) if for every $X\subseteq A$ we have that $\min X$ exists.
\end{df}