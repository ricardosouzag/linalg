...
\begin{proof}
	...
	Assume not - that is, there is some $x\in A\cup B$ that is in neither $A$ nor $B$. Now define $N=\{x\in A\cup B\mid x\notin A\mbox{ and }x\notin B\}$ the collection of all such elements - which is, by definition, a subset of $A\cup B$.
\end{proof}