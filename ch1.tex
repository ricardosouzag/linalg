...
\begin{df}
	Let $X,Y$ be sets. A \textbf{natural transformation $\alpha:\hom(-,X)\to\hom(-,Y)$} is a family of functions $\alpha:=\{\phi_A:\hom(A,X)\to \hom(A,Y)\}_A$, where $A$ ranges over all sets, such that 
	\[\begin{tikzcd}
	...
	If each $\phi_A$ in the family is an isomorphism, then we say that $\alpha$ is a \textbf{natural isomorphism}.
\end{df}

\begin{theorem}[Yoneda's Lemma]\label{thm:yoneda}
	Let $X$ and $Y$ be any sets. Then there is a bijective correspondence between natural transformations between $\hom(-,X)$ and $\hom(-,Y)$, and functions $f:X\to Y$.
\end{theorem}
\begin{proof}
...
\end{proof}
\begin{df}
	Let $X,Y$ be sets. A \textbf{natural transformation $\alpha:\hom(X,-)\to\hom(Y,-)$} is a family of functions $\alpha:=\{\phi_A:\hom(X,A)\to \hom(Y,A)\}_A$, where $A$ ranges over all sets, such that \[\begin{tikzcd}
...
\begin{cor}[Yoneda's Lemma]
	Let $X$ and $Y$ be any sets. Then there is a bijective correspondence between natural transformations $\alpha:\hom(X,-)\to\hom(Y,-)$, and functions $f:Y\to X$.
\end{cor}
\begin{proof}
