...
\begin{proof}
	...
	\[*\leftrightarrow\{a\}\leftrightarrow\bullet,\]where the $\leftrightarrow$ denote the unique isomorphism between the two sets, which is a composition of isomorphisms and, therefore, an isomorphism.
\end{proof}
