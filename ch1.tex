...
\begin{proof}
	\begin{enumerate}[(a)]
		...
		\item Let
		\begin{multicols}{2}$$\pi_A:A\times(B\times C)\to A$$ $$\pi_{B\times C}:A\times(B\times C)\to B\times C$$ $$\pi_B:B\times C\to B$$ $$\pi_C:B\times C\to C$$ $$\pi_{A\times B}:(A\times B)\times C\to A\times B$$ $$\pi'_A:A\times B\to A$$ $$\pi'_B:A\times B\to B$$ $$\pi'_C:(A\times B)\times C\to C$$
		\end{multicols}		
