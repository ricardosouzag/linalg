...
\begin{df}
	Let $A$ and $B$ be two sets. A formula $\phi$ is said to be of \textbf{function type} (or a \textbf{function}) if for any $a\in A$ there's a unique $b\in B$ such that $\phi(a,b)$.
