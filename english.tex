...
\newenvironment{ex}{\begin{tcolorbox}[breakable,colback=blue!5!white,colframe=white!80!black,title=\normalsize {\sc EXAMPLE(S):},coltitle=black]}{\end{tcolorbox}}
\newenvironment{blockenv}[1]{\begin{tcolorbox}[breakable,colback=blue!5!white,colframe=white!80!black,title=\normalsize {\sc #1:},coltitle=black]}{\end{tcolorbox}}

\newcounter{rmk}
\numberwithin{rmk}{section}
\renewcommand*{\thermk}{(\arabic{chapter}.\arabic{section}.\arabic{rmk})}
\newenvironment{rmk}{\stepcounter{rmk}\begin{tcolorbox}[breakable,colback=red!5!white,colframe=red!40!white,title=\normalsize {\sc\textbf{Remark} \thermk},coltitle=black]}{\end{tcolorbox}}

\newcounter{exerc}
\numberwithin{exerc}{section}
\renewcommand*{\theexerc}{(\arabic{chapter}.\arabic{section}.\arabic{df})}
\newenvironment{exerc}{\stepcounter{exerc}\begin{tcolorbox}[breakable,colback=blue!5!white,colframe=blue!40!white,title=\normalsize {\sc\textbf{Exercise} \theexerc},coltitle=black]}{\end{tcolorbox}}
...
\declaretheorem[numberlike=df,name=Theorem,refname={teorema,teoremas},
Refname={Teorema,Teoremas}]{theorem}
\declaretheorem[sibling=df,name=Corolary,refname={corolário,corolários},
Refname={Corolário,Corolários}]{cor}
\declaretheorem[sibling=df,name=Lemma,refname={lema,lemas},
Refname={Lema,Lemas}]{lemma}
\declaretheorem[sibling=df,name=Proposition,refname={proposição,proposições},
